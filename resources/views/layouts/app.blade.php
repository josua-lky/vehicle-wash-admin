        ...
        <nav class="flex-1 py-4 px-2 space-y-0.5 overflow-y-auto sidebar-scrollbar">
            @php
                ...
                $navItems = [
                    ...
                    ['route' => 'onboarding',   'label' => 'Pengenalan Sistem',     'icon' => 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ...
                    ['route' => 'packages',     'label' => 'Paket Layanan',         'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
